...
require('functions/profile_database.inc');
...
$id = $_COOKIE['id'];
$national_code = $_COOKIE['national_code'];
$gender = $_COOKIE['gender'];
$day = substr($_COOKIE['birthday'] , 0 , 2);
$month = substr($_COOKIE['birthday'] , 3 , 2);
$year = substr($_COOKIE['birthday'] , 6 , 4);
$level = $_COOKIE['level'];
if ($gender == 'male')
{
    $gender = 'مرد';
...
<div id="change_info">
    <div>
        ...
        <form class="was-validated" method="post" action="profile.php" enctype="multipart/form-data">
            <?php
            if ( $_COOKIE['level'] == 0 )
            {
                echo "
